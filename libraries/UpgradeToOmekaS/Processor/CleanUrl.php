...
class UpgradeToOmekaS_Processor_CleanUrl extends UpgradeToOmekaS_Processor_Abstract
{
    ...
    protected function _upgradeSettings()
    {
        ...
        $mapOptions = array(
            'clean_url_identifier_element' => 'clean_url_identifier_property',
            'clean_url_identifier_prefix' => 'clean_url_identifier_prefix',
            'clean_url_identifier_unspace' => 'clean_url_identifier_unspace',
            'clean_url_case_insensitive' => 'clean_url_case_insensitive',
            'clean_url_main_path' => 'clean_url_main_path',
            'clean_url_collection_regex' => 'clean_url_item_set_regex',
            'clean_url_collection_generic' => 'clean_url_item_set_generic',
            'clean_url_item_default' => 'clean_url_item_default',
            'clean_url_item_alloweds' => 'clean_url_item_allowed',
            'clean_url_item_generic' => 'clean_url_item_generic',
            'clean_url_file_default' => 'clean_url_media_default',
            'clean_url_file_alloweds' => 'clean_url_media_allowed',
            'clean_url_file_generic' => 'clean_url_media_generic',
            'clean_url_use_admin' => null,
            'clean_url_display_admin_browse_identifier' => 'clean_url_display_admin_show_identifier',
